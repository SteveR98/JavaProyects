...
public class Cadena {
	...
	public static void main(String[] argumentos) //Son varios Strings []// Args array/matriz/vector/tabla
	{
		...
		System.out.println("Palabra 3 = " +argumentos [2]);*/
			...
			int posicionFinal = argumentos.length;// contiene la longitud los numeros de elementos que tiene el array
